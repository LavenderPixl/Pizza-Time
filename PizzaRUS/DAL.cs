...
namespace PizzaRUS
{
    public class DAL
    {
        ...
        private  ObservableCollection<Drinks> DrinksDataBase;
        private  ObservableCollection<Drinks> _DrinksPublicListe;
        ...
        //private  ObservableCollection<Orders> OrdersDataBase;
        //private  ObservableCollection<Orders> _OrdersPublicListe;
        ...
        public DAL()
        {
            ...
            var Dri = JsonConvert.DeserializeObject<ObservableCollection<Drinks>>(DrinksJson);
            DrinksDataBase = new ObservableCollection<Drinks>(Dri);
            _DrinksPublicListe = new();
        ...
        public void JsonFiles()
        {
            ...
            var DrinksJson = JsonConvert.SerializeObject(DrinksDataBase, Formatting.Indented);
